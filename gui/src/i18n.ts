...
const en = {
  ...
  output: {
    ...
    checking: "Checking", notChecked: "Not checked", checkFailedBadge: "Check failed", smart: "Smart render", full: "Full re-encode",
    smartEstimate: "Smart render expected", fullEstimate: "Full re-encode expected",
    estimateSummary: "Estimate based on the {{container}} container and {{codec}} video codec. Check details to inspect keyframes for each clip.",
    checkDetails: "Check smart rendering details",
...
const ja: TranslationShape<typeof en> = {
  ...
  output: {
    ...
    checking: "確認中", notChecked: "チェック前", checkFailedBadge: "チェック失敗", smart: "スマートレンダー", full: "全体を再エンコード",
    smartEstimate: "スマートレンダリング見込み", fullEstimate: "全体再エンコード見込み",
    estimateSummary: "{{container}} コンテナと {{codec}} 動画コーデックによる推定です。各クリップのキーフレームは詳細確認で調べられます。",
    checkDetails: "スマートレンダリング詳細を確認",
    checkingProgress: "確認中... {{completed}}/{{total}}",
